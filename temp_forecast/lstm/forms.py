...
class ForecastForm(forms.Form):
  ...
  dew_point = forms.FloatField(label='Dew Point Temp (°C)',max_value=10000, min_value=0,widget=forms.NumberInput(attrs={'class': 'form-control','id': "formGroupExampleInput",'placeholder':'Enter your dew point...'}))
